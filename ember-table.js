...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers._triageMustache.call(depth0, "view.content.headerCellName", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n  </span>\n</div>");
  return buffer;
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers._triageMustache.call(depth0, "view.cellContent", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n</span>");
  return buffer;
